...
activities = {
    ...
    "Swimming Club": {
        "description": "Build swimming skills and participate in relay meets",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["charlie@mergington.edu", "rachel@mergington.edu"]
    },
    "Art Club": {
        "description": "Create paintings, sketches, and illustrations together",
    ...
    "Debate Team": {
        "description": "Develop public speaking and critical thinking in debate tournaments",
